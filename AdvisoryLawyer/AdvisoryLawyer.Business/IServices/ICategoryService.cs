...
namespace AdvisoryLawyer.Business.IServices
{
    public interface ICategoryService
    {
        ...
        Task<CategoryLawyerUpdate> UpdateCategoryLawyer(CategoryLawyerUpdate request);
        Task<CategoryLawyerOfficeUpdate> UpdateCategoryOfficeLawyer(CategoryLawyerOfficeUpdate request);
    }
}
